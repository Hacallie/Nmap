...
Identify active hosts on my lab network
Perform port scanning to discover open services
Attempt OS detection on target systems
Document findings and methodology
Learn practical network analysis skills
...
🔗 Related Work
Previous Lab: Week 1 - Kali Linux Lab Setup
